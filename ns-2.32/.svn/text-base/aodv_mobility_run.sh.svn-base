...
rpath="/home/shlee/../../mnt/idrmshare/results"
 ...
 if [ $# -ne 9 ]; then
         echo "#of nodes, #of domains, #of gateways, #of traffics, eIDRM beacon, iIDRM beacon, file_name trace_result seed"
         exit 127
    fi


./idrm_setting/setting.sh $1 $2 $3 $4
cp $path/aodv_mobility_traffic.tcl $rpath/$8_traffic.tcl

./ns aodv_mobility.tcl $1 $2 $3 $5 $6 $7 $9 > $rpath/../$8
