...
set topo(25,start_x)				91;		# starting position x
set topo(25,start_y)				980;		# starting position y
set topo(25,num_if_ch)				2;		# num interfaces = number of channels. one-to-one mapping between inteface and channels.
...
set topo(26,start_x)				956;		# starting position x
set topo(26,start_y)				873;		# starting position y
...
set topo(27,start_x)				862;		# starting position x
set topo(27,start_y)				170;		# starting position y
...
set topo(28,start_x)				996;		# starting position x
set topo(28,start_y)				281;		# starting position y
...
set topo(29,start_x)				305;		# starting position x
set topo(29,start_y)				925;		# starting position y
...
set topo(30,start_x)				84;		# starting position x
set topo(30,start_y)				327;		# starting position y
...
set topo(31,start_x)				336;		# starting position x
set topo(31,start_y)				505;		# starting position y
...
set topo(32,start_x)				846;		# starting position x
set topo(32,start_y)				729;		# starting position y
...
set topo(33,start_x)				313;		# starting position x
set topo(33,start_y)				857;		# starting position y
...
set topo(34,start_x)				124;		# starting position x
set topo(34,start_y)				895;		# starting position y
...
set topo(35,start_x)				582;		# starting position x
set topo(35,start_y)				545;		# starting position y
...
set topo(36,start_x)				814;		# starting position x
set topo(36,start_y)				367;		# starting position y
...
set topo(37,start_x)				434;		# starting position x
set topo(37,start_y)				364;		# starting position y
...
set topo(38,start_x)				43;		# starting position x
set topo(38,start_y)				750;		# starting position y
...
set topo(39,start_x)				87;		# starting position x
set topo(39,start_y)				808;		# starting position y
...
set topo(40,start_x)				276;		# starting position x
set topo(40,start_y)				178;		# starting position y
...
set topo(41,start_x)				788;		# starting position x
set topo(41,start_y)				584;		# starting position y
...
set topo(42,start_x)				403;		# starting position x
set topo(42,start_y)				651;		# starting position y
...
set topo(43,start_x)				754;		# starting position x
set topo(43,start_y)				399;		# starting position y
...
set topo(44,start_x)				932;		# starting position x
set topo(44,start_y)				60;		# starting position y
...
set topo(45,start_x)				676;		# starting position x
set topo(45,start_y)				368;		# starting position y
...
set topo(46,start_x)				739;		# starting position x
set topo(46,start_y)				12;		# starting position y
...
set topo(47,start_x)				226;		# starting position x
set topo(47,start_y)				586;		# starting position y
...
set topo(48,start_x)				94;		# starting position x
set topo(48,start_y)				539;		# starting position y
...
set topo(49,start_x)				795;		# starting position x
set topo(49,start_y)				570;		# starting position y
...
set topo(50,start_x)				434;		# starting position x
set topo(50,start_y)				378;		# starting position y
