...
set topo(9,idx_map_if_to_ch,0)			1;		# mapping interface to channel
set topo(9,idx_map_if_to_ch,1)			2;		# mapping interface to channel
set topo(9,idx_map_if_to_ragent,0)		1;		# mapping interface to routing agent
set topo(9,idx_map_if_to_ragent,1)		3;		# mapping interface to routing agent
set topo(9,my_domain)				B;		#set its domain id
set topo(9,my_identity)				1;		#set its identity: 0: non gateway, 1:gateway
set topo(9,my_gateway,0)			9;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,1)			10;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,2)			11;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,3)			12;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,4)			13;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,5)			14;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,6)			15;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,7)			16;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,8)			17;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set nam(9,dom_id)				B;		#domain id
...
set topo(10,my_gateway,0)			9;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(10,my_gateway,1)			10;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(10,my_gateway,2)			11;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(10,my_gateway,3)			12;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(10,my_gateway,4)			13;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(10,my_gateway,5)			14;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(10,my_gateway,6)			15;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(10,my_gateway,7)			16;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(10,my_gateway,8)			17;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(11,my_gateway,0)			9;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(11,my_gateway,1)			10;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(11,my_gateway,2)			11;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(11,my_gateway,3)			12;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(11,my_gateway,4)			13;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(11,my_gateway,5)			14;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(11,my_gateway,6)			15;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(11,my_gateway,7)			16;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(11,my_gateway,8)			17;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(12,my_gateway,0)			9;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(12,my_gateway,1)			10;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(12,my_gateway,2)			11;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(12,my_gateway,3)			12;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(12,my_gateway,4)			13;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(12,my_gateway,5)			14;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(12,my_gateway,6)			15;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(12,my_gateway,7)			16;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(12,my_gateway,8)			17;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(13,my_gateway,0)			9;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(13,my_gateway,1)			10;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(13,my_gateway,2)			11;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(13,my_gateway,3)			12;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(13,my_gateway,4)			13;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(13,my_gateway,5)			14;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(13,my_gateway,6)			15;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(13,my_gateway,7)			16;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(13,my_gateway,8)			17;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(14,my_gateway,0)			9;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(14,my_gateway,1)			10;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(14,my_gateway,2)			11;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(14,my_gateway,3)			12;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(14,my_gateway,4)			13;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(14,my_gateway,5)			14;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(14,my_gateway,6)			15;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(14,my_gateway,7)			16;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(14,my_gateway,8)			17;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(15,my_gateway,0)			9;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(15,my_gateway,1)			10;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(15,my_gateway,2)			11;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(15,my_gateway,3)			12;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(15,my_gateway,4)			13;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(15,my_gateway,5)			14;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(15,my_gateway,6)			15;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(15,my_gateway,7)			16;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(15,my_gateway,8)			17;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(16,my_gateway,0)			9;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(16,my_gateway,1)			10;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(16,my_gateway,2)			11;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(16,my_gateway,3)			12;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(16,my_gateway,4)			13;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(16,my_gateway,5)			14;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(16,my_gateway,6)			15;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(16,my_gateway,7)			16;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(16,my_gateway,8)			17;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(17,my_gateway,0)			9;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(17,my_gateway,1)			10;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(17,my_gateway,2)			11;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(17,my_gateway,3)			12;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(17,my_gateway,4)			13;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(17,my_gateway,5)			14;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(17,my_gateway,6)			15;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(17,my_gateway,7)			16;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(17,my_gateway,8)			17;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
