...
set topo(5,my_gateway,0)			5;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(5,my_gateway,1)			6;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(5,my_gateway,2)			7;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(5,my_gateway,3)			8;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(5,my_gateway,4)			9;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(6,idx_map_if_to_ch,0)			1;		# mapping interface to channel
set topo(6,idx_map_if_to_ch,1)			2;		# mapping interface to channel
set topo(6,idx_map_if_to_ragent,0)		1;		# mapping interface to routing agent
set topo(6,idx_map_if_to_ragent,1)		3;		# mapping interface to routing agent
set topo(6,my_domain)				B;		#set its domain id
set topo(6,my_identity)				1;		#set its identity: 0: non gateway, 1:gateway
set topo(6,my_gateway,0)			5;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(6,my_gateway,1)			6;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(6,my_gateway,2)			7;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(6,my_gateway,3)			8;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(6,my_gateway,4)			9;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set nam(6,dom_id)				B;		#domain id
set nam(6,node_id)				6;		#domain id
set nam(6,color)				red;		#domain id
...
set topo(7,idx_map_if_to_ch,0)			1;		# mapping interface to channel
...
set topo(7,my_gateway,0)			5;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(7,my_gateway,1)			6;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(7,my_gateway,2)			7;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(7,my_gateway,3)			8;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(7,my_gateway,4)			9;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set nam(7,dom_id)				B;		#domain id
set nam(7,node_id)				7;		#domain id
set nam(7,color)				red;		#domain id
...
set topo(8,my_gateway,0)			5;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(8,my_gateway,1)			6;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(8,my_gateway,2)			7;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(8,my_gateway,3)			8;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(8,my_gateway,4)			9;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(9,my_gateway,0)			5;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,1)			6;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,2)			7;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,3)			8;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,4)			9;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
