...
set topo(25,start_x)				124;		# starting position x
set topo(25,start_y)				895;		# starting position y
set topo(25,num_if_ch)				2;		# num interfaces = number of channels. one-to-one mapping between inteface and channels.
...
set topo(25,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(25,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(25,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(25,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(25,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set nam(25,dom_id)				B;		#domain id
set nam(25,node_id)				25;		#domain id
set nam(25,color)				red;		#domain id
set nam(25,shape)				square;		#domain id

set topo(26,start_x)				582;		# starting position x
set topo(26,start_y)				545;		# starting position y
set topo(26,num_if_ch)				2;		# num interfaces = number of channels. one-to-one mapping between inteface and channels.
...
set topo(26,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(26,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(26,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(26,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(26,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set nam(26,dom_id)				B;		#domain id
set nam(26,node_id)				26;		#domain id
set nam(26,color)				red;		#domain id
set nam(26,shape)				square;		#domain id

set topo(27,start_x)				814;		# starting position x
set topo(27,start_y)				367;		# starting position y
set topo(27,num_if_ch)				2;		# num interfaces = number of channels. one-to-one mapping between inteface and channels.
...
set topo(27,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(27,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(27,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(27,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(27,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set nam(27,dom_id)				B;		#domain id
set nam(27,node_id)				27;		#domain id
set nam(27,color)				red;		#domain id
set nam(27,shape)				square;		#domain id

set topo(28,start_x)				434;		# starting position x
set topo(28,start_y)				364;		# starting position y
set topo(28,num_if_ch)				2;		# num interfaces = number of channels. one-to-one mapping between inteface and channels.
...
set topo(28,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(28,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(28,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(28,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(28,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set nam(28,dom_id)				B;		#domain id
set nam(28,node_id)				28;		#domain id
set nam(28,color)				red;		#domain id
set nam(28,shape)				square;		#domain id

set topo(29,start_x)				43;		# starting position x
set topo(29,start_y)				750;		# starting position y
set topo(29,num_if_ch)				2;		# num interfaces = number of channels. one-to-one mapping between inteface and channels.
...
set topo(29,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(29,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(29,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(29,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(29,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set nam(29,dom_id)				B;		#domain id
set nam(29,node_id)				29;		#domain id
set nam(29,color)				red;		#domain id
set nam(29,shape)				square;		#domain id

set topo(30,start_x)				87;		# starting position x
set topo(30,start_y)				808;		# starting position y
set topo(30,num_if_ch)				2;		# num interfaces = number of channels. one-to-one mapping between inteface and channels.
...
set topo(30,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(30,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(30,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(30,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(30,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set nam(30,dom_id)				B;		#domain id
set nam(30,node_id)				30;		#domain id
set nam(30,color)				red;		#domain id
set nam(30,shape)				square;		#domain id

set topo(31,start_x)				276;		# starting position x
set topo(31,start_y)				178;		# starting position y
set topo(31,num_if_ch)				2;		# num interfaces = number of channels. one-to-one mapping between inteface and channels.
...
set topo(31,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(31,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(31,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(31,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(31,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set nam(31,dom_id)				B;		#domain id
set nam(31,node_id)				31;		#domain id
set nam(31,color)				red;		#domain id
set nam(31,shape)				square;		#domain id

set topo(32,start_x)				788;		# starting position x
set topo(32,start_y)				584;		# starting position y
set topo(32,num_if_ch)				2;		# num interfaces = number of channels. one-to-one mapping between inteface and channels.
...
set topo(32,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(32,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(32,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(32,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(32,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set nam(32,dom_id)				B;		#domain id
set nam(32,node_id)				32;		#domain id
set nam(32,color)				red;		#domain id
set nam(32,shape)				square;		#domain id

set topo(33,start_x)				403;		# starting position x
set topo(33,start_y)				651;		# starting position y
set topo(33,num_if_ch)				2;		# num interfaces = number of channels. one-to-one mapping between inteface and channels.
...
set topo(33,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(33,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(33,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(33,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(33,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set nam(33,dom_id)				B;		#domain id
set nam(33,node_id)				33;		#domain id
set nam(33,color)				red;		#domain id
set nam(33,shape)				square;		#domain id

set topo(34,start_x)				754;		# starting position x
set topo(34,start_y)				399;		# starting position y
set topo(34,num_if_ch)				2;		# num interfaces = number of channels. one-to-one mapping between inteface and channels.
...
set topo(34,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(34,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(34,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(34,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(34,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set nam(34,dom_id)				B;		#domain id
set nam(34,node_id)				34;		#domain id
set nam(34,color)				red;		#domain id
set nam(34,shape)				square;		#domain id

set topo(35,start_x)				932;		# starting position x
set topo(35,start_y)				60;		# starting position y
...
set topo(35,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(35,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(35,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(35,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(35,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(36,start_x)				676;		# starting position x
set topo(36,start_y)				368;		# starting position y
...
set topo(36,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(36,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(36,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(36,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(36,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(37,start_x)				739;		# starting position x
set topo(37,start_y)				12;		# starting position y
...
set topo(37,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(37,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(37,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(37,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(37,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(38,start_x)				226;		# starting position x
set topo(38,start_y)				586;		# starting position y
...
set topo(38,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(38,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(38,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(38,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(38,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(39,start_x)				94;		# starting position x
set topo(39,start_y)				539;		# starting position y
...
set topo(39,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(39,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(39,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(39,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(39,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(40,start_x)				795;		# starting position x
set topo(40,start_y)				570;		# starting position y
...
set topo(40,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(40,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(40,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(40,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(40,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(41,start_x)				434;		# starting position x
set topo(41,start_y)				378;		# starting position y
...
set topo(41,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(41,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(41,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(41,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(41,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(42,start_x)				467;		# starting position x
set topo(42,start_y)				601;		# starting position y
...
set topo(42,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(42,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(42,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(42,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(42,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(43,start_x)				97;		# starting position x
set topo(43,start_y)				902;		# starting position y
...
set topo(43,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(43,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(43,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(43,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(43,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(44,start_x)				317;		# starting position x
set topo(44,start_y)				492;		# starting position y
...
set topo(44,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(44,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(44,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(44,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(44,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(45,start_x)				652;		# starting position x
set topo(45,start_y)				756;		# starting position y
...
set topo(45,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(45,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(45,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(45,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(45,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(46,start_x)				301;		# starting position x
set topo(46,start_y)				280;		# starting position y
...
set topo(46,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(46,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(46,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(46,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(46,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(47,start_x)				286;		# starting position x
set topo(47,start_y)				441;		# starting position y
...
set topo(47,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(47,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(47,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(47,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(47,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(48,start_x)				865;		# starting position x
set topo(48,start_y)				689;		# starting position y
...
set topo(48,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(48,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(48,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(48,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(48,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(49,start_x)				444;		# starting position x
set topo(49,start_y)				619;		# starting position y
...
set topo(49,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(49,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(49,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(49,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(49,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(50,start_x)				440;		# starting position x
set topo(50,start_y)				729;		# starting position y
...
set topo(50,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(50,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(50,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(50,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(50,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(51,start_x)				31;		# starting position x
set topo(51,start_y)				117;		# starting position y
...
set topo(51,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(51,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(51,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(51,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(51,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(52,start_x)				97;		# starting position x
set topo(52,start_y)				771;		# starting position y
...
set topo(52,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(52,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(52,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(52,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(52,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(53,start_x)				481;		# starting position x
set topo(53,start_y)				675;		# starting position y
...
set topo(53,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(53,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(53,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(53,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(53,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(54,start_x)				709;		# starting position x
set topo(54,start_y)				927;		# starting position y
...
set topo(54,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(54,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(54,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(54,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(54,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(55,start_x)				567;		# starting position x
set topo(55,start_y)				856;		# starting position y
...
set topo(55,my_gateway,0)			25;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,1)			26;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,2)			27;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,3)			28;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,4)			29;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,5)			30;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,6)			31;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,7)			32;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,8)			33;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,9)			34;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,10)			35;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,11)			36;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,12)			37;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,13)			38;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,14)			39;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,15)			40;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,16)			41;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,17)			42;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,18)			43;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,19)			44;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,20)			45;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,21)			46;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,22)			47;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,23)			48;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,24)			49;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,25)			50;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,26)			51;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,27)			52;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,28)			53;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,29)			54;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(55,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(56,start_x)				497;		# starting position x
set topo(56,start_y)				353;		# starting position y
...
set topo(56,my_gateway,0)			25;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,1)			26;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,2)			27;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,3)			28;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,4)			29;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,5)			30;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,6)			31;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,7)			32;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,8)			33;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,9)			34;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,10)			35;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,11)			36;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,12)			37;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,13)			38;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,14)			39;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,15)			40;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,16)			41;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,17)			42;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,18)			43;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,19)			44;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,20)			45;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,21)			46;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,22)			47;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,23)			48;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,24)			49;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,25)			50;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,26)			51;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,27)			52;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,28)			53;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,29)			54;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(56,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(57,start_x)				586;		# starting position x
set topo(57,start_y)				965;		# starting position y
...
set topo(57,my_gateway,0)			25;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,1)			26;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,2)			27;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,3)			28;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,4)			29;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,5)			30;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,6)			31;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,7)			32;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,8)			33;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,9)			34;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,10)			35;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,11)			36;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,12)			37;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,13)			38;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,14)			39;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,15)			40;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,16)			41;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,17)			42;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,18)			43;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,19)			44;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,20)			45;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,21)			46;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,22)			47;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,23)			48;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,24)			49;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,25)			50;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,26)			51;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,27)			52;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,28)			53;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,29)			54;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(57,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(58,start_x)				306;		# starting position x
set topo(58,start_y)				683;		# starting position y
...
set topo(58,my_gateway,0)			25;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,1)			26;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,2)			27;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,3)			28;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,4)			29;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,5)			30;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,6)			31;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,7)			32;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,8)			33;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,9)			34;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,10)			35;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,11)			36;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,12)			37;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,13)			38;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,14)			39;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,15)			40;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,16)			41;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,17)			42;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,18)			43;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,19)			44;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,20)			45;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,21)			46;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,22)			47;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,23)			48;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,24)			49;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,25)			50;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,26)			51;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,27)			52;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,28)			53;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,29)			54;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(58,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
...
set topo(59,start_x)				219;		# starting position x
set topo(59,start_y)				624;		# starting position y
...
set topo(59,my_gateway,0)			25;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,1)			26;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,2)			27;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,3)			28;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,4)			29;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,5)			30;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,6)			31;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,7)			32;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,8)			33;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,9)			34;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,10)			35;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,11)			36;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,12)			37;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,13)			38;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,14)			39;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,15)			40;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,16)			41;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,17)			42;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,18)			43;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,19)			44;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,20)			45;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,21)			46;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,22)			47;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,23)			48;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,24)			49;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,25)			50;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,26)			51;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,27)			52;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,28)			53;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,29)			54;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,30)			55;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,31)			56;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,32)			57;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,33)			58;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
set topo(59,my_gateway,34)			59;		#Set its gateway nodes: Positive:Gateway nodeId, Negative:NULL
