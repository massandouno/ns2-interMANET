...
echo "$total1 $total_var1 $inter1 $inter_var1 $intra1 $intra_var1 $ntotal1 $ntotal_var1"
echo "$total2 $total_var2 $inter2 $inter_var2 $intra2 $intra_var2 $ntotal2 $ntotal_var2"
echo "$total3 $total_var3 $inter3 $inter_var3 $intra3 $intra_var3 $ntotal3 $ntotal_var3"
echo "$total6 $total_var6 $inter6 $inter_var6 $intra6 $intra_var6 $ntotal6 $ntotal_var6"
echo "$total4 $total_var4 $inter4 $inter_var4 $intra4 $intra_var4 $ntotal4 $ntotal_var4"
echo
...
echo "Overhead:"
echo "$overhead1 $variance1"
echo "$overhead2 $variance2"
echo "$overhead3 $variance3"
echo "$overhead6 $variance6"
echo "$overhead4 $variance4"
echo
