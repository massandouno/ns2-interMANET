...
set topo(ng)		 7;# for 1st policy 3; 													# max number of gateway nodes
...
#0102
set topo(method) 1; #change da method

#0214
set topo(dynamic) 50; #earlier 1
...
#set position
source "testcases/cs218_grid_3domains_policy_topology3.tcl"
...
for {set i 0} {$i < $topo(nn)} {incr i} {
    ...
    #set DomainId, Identity, and number of gateways.. //cs218_idrm1
    $ns idrm_set $topo($i,my_domain) $topo($i,my_identity) $topo(ng) $topo(dnn) $file_name $topo(eb) $topo(ib) $topo(method) $topo(dynamic) $topo(schannel) $nam($i,color)
...
#set mobility
source "testcases/cs218_grid_3_domain_mobility_policy3.tcl"


set nt 1;
#set traffic(0,src)                              12;
#set traffic(0,dst)                              0;
#set traffic(0,pksize)                           1000 ;
#set traffic(0,rate)                             1Mb ;
#set traffic(0,startoffset)              150.000000 ;
