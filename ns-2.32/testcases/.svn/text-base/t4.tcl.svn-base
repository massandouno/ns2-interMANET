...
set topo(nn)     20; 													# Number of nodes 
set topo(grid_x) 2500;													# grid length in meters
set topo(grid_y) 2500;													# grid width in meters
set file_name tmp;

#IDRM_SH
set topo(nd)		 5;														# number of domains
set topo(ng)		 4; 													# max number of gateway nodes
...
#set position
source "testcases/t4_topology.tcl"
...
set nf [open dump_files/idrm.nam w]
$ns namtrace-all-wireless $nf $topo(grid_x) $topo(grid_y)
$ns trace-all $nf

#Open the Trace file
set tf [open dump_files/idrm.tr w]
$ns trace-all $tf
...
#set mobility
source "testcases/t4_mobility.tcl"
