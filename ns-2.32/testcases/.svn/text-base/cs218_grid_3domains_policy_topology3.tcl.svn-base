...
set topo(0,start_y)                             440;            # starting position y
...
set topo(1,start_x)                             220;            # starting position x
set topo(1,start_y)                             440;            # starting position y
...
set topo(2,start_x)                             440;            # starting position x
set topo(2,start_y)                             440;            # starting position y
...
set topo(3,start_x)                             440;            # starting position x
set topo(3,start_y)                             220;            # starting position y
...
set topo(3,idx_map_if_to_ragent,1)              3;              # mapping interfacset topo(0,my_domain)                           A;              #set its domain id
...
set topo(4,start_x)                             440;           # starting position x
set topo(4,start_y)                             0;            # starting position y
...
set topo(5,start_x)                             2000;           # starting position x
set topo(5,start_y)                             2000;            # starting position y
...
set topo(6,start_x)                             2000;            # starting position x
set topo(6,start_y)                             2000;              # starting position y
...
set topo(7,start_x)                             660;           # starting position x
set topo(7,start_y)                             440;              # starting position y
...
set topo(7,idx_map_if_to_ragent,0)              1;              # mapping interface to routing agent
set topo(7,idx_map_if_to_ragent,1)              3;              # mapping interface to routing agent
set topo(7,my_domain)                           B;              #set its domain id
set topo(7,my_identity)                         1;              #set its identity: 0: non gateway, 1:gateway
set topo(7,my_gateway,0)                        7;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(7,my_gateway,1)                        8;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(7,my_gateway,2)                        9;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(7,my_gateway,3)                        10;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(7,my_gateway,4)                        11;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(7,my_gateway,5)                        12;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(7,my_gateway,6)                        13;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set nam(7,dom_id)                               B;              #domain id
set nam(7,node_id)                              7;              #domain id
set nam(7,color)                                green;          #domain id
set nam(7,shape)                                square;         #domain id

set topo(8,start_x)                             660;           # starting position x
...
set topo(8,my_gateway,0)                        7;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(8,my_gateway,1)                        8;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(8,my_gateway,2)                        9;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(8,my_gateway,3)                        10;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(8,my_gateway,4)                        11;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(8,my_gateway,5)                        12;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(8,my_gateway,6)                        13;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set nam(8,dom_id)                               B;              #domain id
set nam(8,node_id)                              8;              #domain id
set nam(8,color)                                green;          #domain id
set nam(8,shape)                                square;         #domain id

set topo(9,start_x)                            770;           # starting position x
set topo(9,start_y)                            220;            # starting position y
...
set topo(9,my_gateway,0)                        7;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,1)                        8;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,2)                        9;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,3)                        10;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,4)                        11;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,5)                        12;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(9,my_gateway,6)                        13;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set nam(9,dom_id)                               B;              #domain id
set nam(9,node_id)                             9;             #domain id
set nam(9,color)                               green;          #domain id
set nam(9,shape)                               square;         #domain id

set topo(10,start_x)                            2000;           # starting position x
set topo(10,start_y)                            2000;            # starting position y
...
set topo(10,my_gateway,0)                        7;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(10,my_gateway,1)                        8;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(10,my_gateway,2)                        9;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(10,my_gateway,3)                        10;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(10,my_gateway,4)                        11;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(10,my_gateway,5)                        12;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(10,my_gateway,6)                        13;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set nam(10,dom_id)                               B;              #domain id
set nam(10,node_id)                             10;             #domain id
set nam(10,color)                               green;          #domain id
set nam(10,shape)                               square;         #domain id

set topo(11,start_x)                            2000;           # starting position x
set topo(11,start_y)                            2000;            # starting position y
...
set topo(11,my_gateway,0)                        7;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(11,my_gateway,1)                        8;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(11,my_gateway,2)                        9;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(11,my_gateway,3)                        10;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(11,my_gateway,4)                        11;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(11,my_gateway,5)                        12;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(11,my_gateway,6)                        13;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set nam(11,dom_id)                               B;              #domain id
set nam(11,node_id)                             11;             #domain id
set nam(11,color)                               green;          #domain id
set nam(11,shape)                               square;         #domain id

set topo(12,start_x)                            2000;           # starting position x
set topo(12,start_y)                            2000;            # starting position y
...
set topo(12,my_gateway,0)                        7;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(12,my_gateway,1)                        8;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(12,my_gateway,2)                        9;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(12,my_gateway,3)                        10;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(12,my_gateway,4)                        11;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(12,my_gateway,5)                        12;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(12,my_gateway,6)                        13;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
...
set topo(13,start_x)                            2000;           # starting position x
set topo(13,start_y)                            2000;            # starting position y
...
set topo(13,my_gateway,0)                        7;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(13,my_gateway,1)                        8;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(13,my_gateway,2)                        9;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(13,my_gateway,3)                        10;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(13,my_gateway,4)                        11;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(13,my_gateway,5)                        12;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
set topo(13,my_gateway,6)                        13;              #Set its gateway nodes:Positive:Gateway nodeId, Negative:NULL
