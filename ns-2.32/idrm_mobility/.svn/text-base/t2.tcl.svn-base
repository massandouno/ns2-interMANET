...
set traffic(4,src)                               4;                              #Src node ID in MANET A
set traffic(4,dst)                               5;                              #Dest node ID in MANET B
set traffic(4,pksize)  			        						 64;  		         						 #Packet size in bytes
set traffic(4,period)                    	 			 1.0;           		 						 #Period in secs
set traffic(4,rate) 														 0.0001Mb;														 #data rate
set traffic(4,startoffset) 											 1.0;                 		 			 #Offset in secs

set traffic(5,src)                               1;                              #Src node ID in MANET A
set traffic(5,dst)                               5;                              #Dest node ID in MANET B
set traffic(5,pksize)                            1400;                           #Packet size in bytes
set traffic(5,period)                            0.1;                            #Period in secs
set traffic(5,rate) 														 10Mb;														 #data rate
